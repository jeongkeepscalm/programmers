...
public class Main1 {
    public static void main(String[] args) {
        ...
        _042.solution(new int[]{1, 5, 2, 6, 3, 7, 4}, new int[][]{{2, 5, 3}, {4, 4, 1}, {1, 7, 3}}); // System.arraycopy() || Arrays.copyOfRange()
        _044.theOtherSolution(new String[]{"dfs", "abc", "axx"}, 0); // ★ comparator
        _045.theOtherSolution(3, 1, 20); // * 콜라 문제
        _046.theBestSolution(6, new int[]{46, 33, 33, 22, 311, 50}, new int[]{27, 56, 19, 14, 14, 10}); // Binary
        _047.theBestSolution(4, new int[]{0, 300, 40, 300, 20, 70, 150, 50, 500, 1000});
        _049.solution(new String[]{"i", "drink", "water"}, new String[]{"want", "to"}, new String[]{"i", "want", "to", "drink", "water"}); // Deque        _050.theBestSolution(new int[]{1, 2, 3, 2});            // stream
